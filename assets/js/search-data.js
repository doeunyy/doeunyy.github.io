...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "cv",
          description: "Academic CV and selected experience.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-jeans",
          title: 'Jeans',
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-multimodal-entrance-detection",
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-pokerbench",
          title: 'PokerBench',
          description: "Small language model training and evaluation for poker decision-making under uncertainty.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/pokerbench/";
            },},{id: "projects-talesrunner",
          title: 'TalesRunner',
          description: "AI-powered storybook generation from user-provided images.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/talesrunner/";
            },},{id: "projects-teammate",
          title: 'Teammate',
          description: "Backend service for team sports matching, player recruitment, and venue coordination.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/teammate/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%64%6F%65%75%6E%6B%69%6D.%63%73@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/doeunyy", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/doeun-kim", "_blank");
        },
      },{
      id: 'light-theme',
